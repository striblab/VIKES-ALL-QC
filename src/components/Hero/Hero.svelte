...
<Grid additionalClasses="">
  <GridRow variant={'fullBleed'}>
    ...
    <div class="desktop-hero-image hidden md:block max-w-[1800px] mx-auto">
      <img
        class=""
        alt="Viking Quarter Century Team hero"
        src="https://ststatic.stimg.co/news/projects/all/2025-VIKES-ALLQC/img/ALLQChero.jpg?w=1800"
      />
    </div>
  ...
  <GridRow additionalClasses="justify-self-center text-center w-[100vw]">
    ...
    <a
      ...
      class="Button_button__9QGZa link large-size Button_button-link__auMnb"
      href="/sports/vikings"
    >
      <p
        class="px-4 rt-Text break-words text-text-color-01 uppercase font-utility-label-bold-caps-02 text-center"
      >
        Vikings
      </p>
    </a>
    ...
    <div
      class="flex flex-col gap-y-6 md:gap-y-8 text-center max-w-[1200px] mx-auto leading-[1] pb-4 md:pb-6 pt-4"
    >
      <h1
    ...
    <div
      class="flex flex-col gap-y-5 md:justify-items-center md:items-center mx-auto px-4"
    >
      <h2
      ...
      <div class="mt-4">
        <span class="font-utility-label-bold-02 text-text-primary"
          ><a
            href="https://www.startribune.com/author/mark-craig/6370584"
            target="_blank"
            class="whitespace-nowrap">Mark Craig</a
          ></span
        >,
        <span class="font-utility-label-bold-02 text-text-primary"
          ><a
            href="https://www.startribune.com/author/ben-goessling/6134708"
            target="_blank"
            class="whitespace-nowrap">Ben Goessling</a
          ></span
        >,
        <span class="font-utility-label-bold-02 text-text-primary"
          ><a
            href="https://www.startribune.com/author/andrew-krammer/6370577"
            target="_blank"
            class="whitespace-nowrap">Andrew Krammer</a
          ></span
        >
        <span
          class="text-text-secondary font-utility-label-reg-02 block mt-[6px]"
          >The Minnesota Star Tribune</span
        >
      </div>
      <span
        class="mb-4 font-utility-label-reg-caps-03 text-text-secondary mt-0"
      >
  ...
  <GridRow
    additionalClasses="justify-self-center text-center w-[80%] md:w-[60%] mx-auto pt-12 pb-0"
  >
