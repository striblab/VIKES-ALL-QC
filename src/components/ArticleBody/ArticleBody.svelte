...
<Grid additionalClasses={'gap-y-0'}>
  <GridRow variant={'inline'} additionalClasses={'gap-y-5 pt-2 pb-6'}>
    ...
    <Paragraph>
      <iframe
        ...
        src="https://www.youtube.com/embed/1FxJUubvDCc"
  ...
  <GridRow variant={'fullBleed'} additionalClasses="max-w-[2200px]">
    ...
    <nav
      ...
      class="cardNav toggler px-4 py-4 text-[1rem] leading-[100%] md:text-[1.15em] text-center mx-auto font-[Graphik-regular] letterspacing-[2px] sticky z-20 bg-[white]"
    >
      {#each groups as g}
        <button
          type="button"
